...
package gradle.kotlin.dsl.plugins._641900de3132d43a50e7a13453a8b1a8
...
/**
 * The `info` plugin group.
 */
@org.gradle.api.Generated
internal
class `InfoPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `info`.
 */
internal
val `PluginDependenciesSpec`.`info`: `InfoPluginGroup`
    get() = `InfoPluginGroup`(this)


/**
 * The `info.solidsoft` plugin group.
 */
@org.gradle.api.Generated
internal
class `InfoSolidsoftPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `info.solidsoft`.
 */
internal
val `InfoPluginGroup`.`solidsoft`: `InfoSolidsoftPluginGroup`
    get() = `InfoSolidsoftPluginGroup`(plugins)


/**
 * The `info.solidsoft.pitest` plugin implemented by [info.solidsoft.gradle.pitest.PitestPlugin].
 */
internal
val `InfoSolidsoftPluginGroup`.`pitest`: PluginDependencySpec
    get() = plugins.id("info.solidsoft.pitest")
